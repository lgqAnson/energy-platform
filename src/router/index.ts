...
},
{
  ...
  component: () => import('@/views/energy-storage/StationForm.vue')
},
      {
        path: 'solar/monitor',
        name: 'SolarMonitor',
        component: () => import('@/views/solar/Monitor.vue'),
        meta: { title: '光伏-实时监控', menu: 'solar' }
      },
      {
        path: 'solar/device',
        name: 'SolarDevice',
        component: () => import('@/views/solar/Device.vue'),
        meta: { title: '光伏-设备管理', menu: 'solar' }
      },
      {
        path: 'solar/metering',
        name: 'SolarMetering',
        component: () => import('@/views/solar/Metering.vue'),
        meta: { title: '光伏-计量与能效', menu: 'solar' }
      },
      {
        path: 'solar/maintenance',
        name: 'SolarMaintenance',
        component: () => import('@/views/solar/Maintenance.vue'),
      ...
      },
      {
        ...
        name: 'CommercialLoad',
        component: () => import('@/views/CommercialLoad.vue'),
